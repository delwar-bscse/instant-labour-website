  ...
  return (
    <div className='maxWidth pt-4 pb-20'>
      ...
      <div className='flex gap-2 py-4 md:py-6 items-center flex-wrap'>
        <div>
          <CustomButton url={`/employer/posted-job/edit-job/${jobDetails._id}`} text="Edit Post" variant="button01" className='w-full' />
        </div>
        <div>
          <Link href={`/employer/posted-job/worker-list?type=applied`} className='w-full border py-2 px-3 rounded-sm border-red-500 hover:bg-red-500 hover:text-white transition-colors duration-300'>Applied Workers</Link>
        </div>
        <div>
